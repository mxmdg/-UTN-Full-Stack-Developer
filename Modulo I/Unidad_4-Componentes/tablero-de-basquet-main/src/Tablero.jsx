      ...
      <>
        ...
        <div className='tablero_grupo'>
          <div className='contenedor_local'>
            ...
            <button className='btn_inc' onClick={this.pointsHandler}>+ 1</button>
            <button className='btn_inc' onClick={this.pointsHandler}>+ 2</button>
            <button className='btn_inc' onClick={this.pointsHandler}>+ 3</button>
            <button className='btn_dec' onClick={this.pointsHandler}>- 1</button>
            <button className='btn_dec' onClick={this.pointsHandler}>- 2</button>
            <button className='btn_dec' onClick={this.pointsHandler}>- 3</button>
          </div>
        ...
        <button onClick={this.resetHandler} className="btn_reset">Reiniciar tablero</button>
      </>
    )
  }
}
